...
function updateDrop(){if(sym.isPlaying()){drop();}}
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1000,function(sym,e){sym.getVariable("updateDrop")();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",3500,function(sym,e){sym.getVariable("updateDrop")();});
//Edge binding end
})("stage");
